  ...
  values: [
    {
      ...
      description:
        "We celebrate the beauty of Sri Lankan and European traditions, creating experiences that unite communities.",
    },
    {
      title: "Creativity & Innovation",
      description:
        "We push artistic boundaries through film, music, theatre, and immersive cultural showcases.",
    },
    {
      title: "Community",
      description:
        "We believe in bringing people together through shared experiences, stories, and artistic expression.",
    },
    {
      title: "Excellence",
      description:
        "Every event, production, and performance is crafted with care, passion, and professional precision.",
    },
  ],
};
